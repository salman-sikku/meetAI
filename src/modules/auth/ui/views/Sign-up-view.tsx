...
const fromSchema = z.object({
   ...
   confirmPassword: z.string().min(1, { message: "Passowrd is required" })
      ...
      <div className='flex flex-col gap-6'>
         <Card className='overflow-hidden p-0'>
            <CardContent className='grid md:grid-cols-2 p-0'>
               <Form {...form}>
                  <form onSubmit={form.handleSubmit(onSubmit)} className="p-6 md:p-8">
                     <div className="flex flex-col gap-6">
                           ...
                           <FormField
                              ...
                              render={({ field }) => ( 
                                 <FormItem>
                                    ...
                                    <FormControl>
                                       <Input type="text" placeholder="jonh Doc" {...field} />
                                    </FormControl>
                                 </FormItem>
                              )}
                           />
                        ...
                        <Button disabled={panding} type="submit" className="w-full">Sign up</Button>
                        <div className="after:border-border relative text-sm text-center after:absolute after:inset-0 after:top-1/2 after:flex after:items-center after:border-t">
               ...
               <div className='bg-radial from-green-700 to-green-900 relative hidden md:flex flex-col justify-center items-center gap-y-4'>
